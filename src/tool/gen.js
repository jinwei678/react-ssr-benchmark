...
// TODO use cli 
var content = fs.readFileSync('../source/teacher.html').toString();
...
fs.writeFileSync("../components/teacher.js", ["var React = require('react')", "var FastReact = require('fast-react-server')",'var A=' + A, 'var B=' + B, 'exports.A = A;exports.B = B', 'exports.info='+info].join(';'));
